          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: CachedNetworkImage(
                imageUrl: flashdeal.detail.banner != null
                    ? img_url + flashdeal.detail.banner
                    : "",
                placeholder: (context, url) => LoadingWidgetPulse(context),
                errorWidget: (context, url, error) =>
                    Image.asset('assets/images/1680x600.png'),
                fit: BoxFit.cover,
              ),
            ),
            Container(
                    ...
                    child: Text(
                      DateTime.now().isBefore(
                              DateTime.fromMillisecondsSinceEpoch(
                                  flashdeal.detail.startDate * 1000))
                          ? 'DIMULAI DALAM'
                          : 'BERAKHIR DALAM',
                      style: TextStyle(
                        fontFamily: "Brandon",
                          ...
                          for (FlashSaleProduct e in flashdeal.flash_products)
                            Container(
                              child: MyProductFlash(
                                productFlash: e,
                                IsLiked: Provider.of<WishModel>(context)
                                            .rawlist
                                            .firstWhere(
                                                (element) =>
                                                    element.productId ==
