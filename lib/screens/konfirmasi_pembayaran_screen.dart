...
class _KonfirmasiPembayaranScreenState
  ...
  _fetchInsert() async {
    ...
    var request = http.MultipartRequest("POST",
        Uri.parse(paymentConfrim + "/" + widget.manualInfo.id.toString()));
    if (_image != null) {
  ...
  Widget _imageFile() {
    return InkWell(
      ...
      child: Center(
        child: _image != null
            ? Image.file(_image)
            : Image.network(img_url + widget.manualInfo.orderConfrim.uploadImg),
      ),
    );
  }
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  nm_format.format(
                                      int.parse(widget.manualInfo.grandTotal) +
                                          int.parse(
                                              widget.manualInfo.uniqTfManual)),
                                  style: TextStyle(
                                    fontFamily: 'Brandon',
                                    color: Colors.white,
                                    fontSize: 16,
