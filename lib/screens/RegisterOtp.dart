...
class RegisterOtpScreen extends StatefulWidget {
  static const String id = "register_otp_Screen";
  User user;
  RegisterOtpScreen({this.user});
  @override
  _RegisterOtpScreen createState() => _RegisterOtpScreen();
}

class _RegisterOtpScreen extends State<RegisterOtpScreen> {
  ...
  _fetchRegister() async {
    ...
    var param ={
      "first_name":nama_depan.value.text,
