                          ...
                          child: Row(
                            children: [
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    final skincare =value.categoris.firstWhere((element) => element.id == 9 );
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    final skincare =value.categoris.firstWhere((element) => element.id == 10 );
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Skincare(category: skincare,) ));
                                  },
                                  child: Column(
                                    children: [
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    final skincare =value.categoris.firstWhere((element) => element.id == 11 );
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Skincare(category: skincare,) ));
                                  },
                                  child: Column(
                                    children: [
                              ...
                              Expanded(
                                ...
                                child: InkWell(
                                  onTap: (){
                                    final skincare =value.categoris.firstWhere((element) => element.id == 15 || element.name == "SKIN CONCERN" );
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => Skincare(category: skincare,) ));
                                  },
                                  child: Column(
                                    children: [
                      ...
                      child: Consumer<ProductModel>(
                        builder: (context,value,child){
                          if(value.loadingBestSale){
                            ...
                            var data =Lodash().chunk(array: flashdeal.flash_products,size: 3);
                            return  new Swiper(
                              itemBuilder: (BuildContext context, int index) {
                                if(data[index].length == 3){
                                  return Container(
                                      child: Row(
                                          children: [
                                            for(FlashSaleProduct e in data[index])
                                              Expanded(
                                                flex: 1,
                                                child: Container(
                ...
                child: Consumer<ProductModel>(
                  builder: (context,value,child){
                    if(value.loadingBestSale){
                      ...
                      var dataBest =Lodash().chunk(array: value.Best_sell,size: 3);
                      return  new Swiper(
                        itemBuilder: (BuildContext context, int index) {
                ...
                child: Consumer<ProductModel>(
                  builder: (context,value,child){
                    if(value.loadingPhobe){
                      ...
                      var dataPhoby  =Lodash().chunk(array: value.PhoebeChoices,size: 3);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: FlatButton(
                        onPressed: (){
                          _launchURL("https://www.youtube.com/c/PonnyBeaute");
                        },
                        padding: EdgeInsets.symmetric(horizontal: 10),
