        ...
        body: Stack(children: <Widget>[
          Scaffold(
            ...
            body: FutureBuilder<NewManualInfo>(
              ...
              builder: (BuildContext context, AsyncSnapshot<NewManualInfo> snapshot){
                print("snaaaap");
                print(snapshot.data);
                if(snapshot.hasData){
                  print("sukses dong");
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          nm_format.format(int.parse(snapshot.data.grandTotal)),
                                          style: TextStyle(
                                            fontFamily: 'Brandon',
                                            color: Colors.white,
                                            fontSize: 14,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          nm_format.format(int.parse(snapshot.data.uniqTfManual)),
                                          style: TextStyle(
                                            fontFamily: 'Brandon',
                                            color: Colors.white,
                                            fontSize: 14,
                          ...
                          Container(
                            ...
                            child: SizedBox(
                              ...
                              child: OutlineButton(
                                ...
                                highlightedBorderColor: Color(0xffF48262),
                                onPressed: (){
                                  int total = int.parse(snapshot.data.grandTotal)+int.parse(snapshot.data.uniqTfManual);
