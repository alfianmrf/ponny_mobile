...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> pointClicked(Info info) async {
    var token = Provider.of<AppModel>(context, listen: false).auth.access_token;
    info.claimToday == true
        ? scaffoldkey.currentState.showSnackBar(SnackBar(
            content: Text('Maaf, hari ini kamu udah claim point.',
                style: TextStyle(color: Colors.white)),
            backgroundColor: Colors.redAccent,
          ))
        : await Provider.of<ClaimPointHarian>(context)
            .claimPointHarian(info, token);
  }
            ...
            builder: (context, value, child) {
              return SingleChildScrollView(
                child: value.isLoading ||
                        Provider.of<UserModel>(context).loadingUser
                    ? Container(
                                            ...
                                            Expanded(
                                              child: Container(
                                                child: LinearPercentIndicator(
                                                  lineHeight: 8.0,
                                                  percent: user.dashboard
                                                              .membershipTitle
                                                              .toUpperCase() ==
                                                          "OH HAPPY"
                                                      ? 1
                                                      : user.dashboard.percent /
                                                          100,
                                      ...
                                      Container(
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            if (user.dashboard.membershipTitle
                                                    .toUpperCase() !=
                                                "OH HAPPY")
                                              Container(
                                                child: Text(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: RichText(
                                              ...
                                              TextSpan(
                                                  text: value.InfoPoint
                                                              .claimToday ==
                                                          false
                                                      ? 'Kunjungan kamu hari ini mendapat '
                                                      : 'Checkin besok untuk mendapatkan ',
                                                  style: TextStyle(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                        image: DecorationImage(
                                                                            image:
                                                                                AssetImage("assets/images/icon-checked.png"),
