...
class _ShippingScreenState extends State<ShippingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      Provider.of<AddressModel>(context)
          .getListAddress(Provider.of<AppModel>(context).auth.access_token)
          .then((value) async {
        if (Provider.of<AddressModel>(context).useAddress != null)
          await Provider.of<AddressModel>(context)
              .getListCourier(Provider.of<AppModel>(context).auth.access_token);
        isloading = false;
        isloading = false;
      });
    });
      ...
      builder: (context, scrollController) => Container(
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              final address =
                  Provider.of<AddressModel>(context).listAdress[index];
              return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Provider.of<AddressModel>(context)
                          ...
                          .then((value) {
                        Provider.of<AddressModel>(context)
                            .getListCourier(Provider.of<AppModel>(context)
                                .auth
                                .access_token)
                            .then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AddressModel>(builder: (context, value, child) {
      if (value.loading) {
        return Scaffold(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(
                                          value.useAddress.nama_depan +
                                              " " +
                                              value.useAddress.nama_belakang,
                                          style: TextStyle(
                                            fontFamily: 'Brandon',
                                            fontSize: 14,
                                            fontWeight: FontWeight.w600,
                                        ...
                                        Text(
                                          value.useAddress.kecamatan +
                                              ', ' +
                                              value.useAddress.city_name +
                                              ',' +
                                              value.useAddress.province +
                                              ',' +
                                              value.useAddress.postal_code,
                                          style: TextStyle(
                                            fontFamily: 'Brandon',
                                            fontSize: 14,
                                          ),
