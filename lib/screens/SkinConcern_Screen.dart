...
class SkinConcern extends StatefulWidget {
  static const String id = "SkinConcern_Screen";

  @override
  _SkinConcernState createState() => _SkinConcernState();
}

class _SkinConcernState extends State<SkinConcern> {
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: rectanglebutton(context, "JERAWAT", 'assets/images/browse/concern/jerawat.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "PORI-PORI BESAR /\nMINYAK BERLEBIH", 'assets/images/browse/concern/pori besar.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "TANDA PENUAAN /\nKERIPUT", 'assets/images/browse/concern/keriput.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "PIGMENTASI &\nNODA HITAM", 'assets/images/browse/concern/noda hitam.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "KERING /\nDEHIDRASI", 'assets/images/browse/concern/kering.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "KEMERAHAN", 'assets/images/browse/concern/kemerahan.png'),
                          ),
                          Container(
                            margin: EdgeInsets.all(10),
                            child: rectanglebutton(context, "SENSITIF", 'assets/images/browse/concern/sensitif.png'),
                          ),
                        ],
                      ),
                    ),
...
Widget rectanglebutton(context, String subtext, String subimg) {
  return ButtonTheme(
    ...
    child: RaisedButton(
      onPressed: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => SkinConcern()));
      },
      child: Column(
