...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Future<void> _getCartOfitem() async {
    ...
    if (auth.loggedIn) {
      await Provider.of<CartModel>(context).getCart(auth.auth.access_token).then((value) {
        if(value == true){
        }
      });
    }
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.product.varian.length > 0) {
        ...
        for (Varian item in widget.product.varian) {
          option.add(ChoiceOptionsValue(
              atributId: item.attribute_id, value: item.values[0]));
        }
  ...
  void _getPriceVarian() {
    var param = <String, dynamic>{"id": widget.product.id, "quantity": 1};
            ...
            children: <Widget>[
              Container(
                ...
                child: CachedNetworkImage(
                  imageUrl: widget.product.thumbnail_image != null
  ...
  Future<Null> _getData() async {
    ...
    final response =
        await http.get(reviewList + "/" + widget.product.id.toString());
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            iconSize: 50,
                            onPressed: () {
                              String url = "https://twitter.com/share?url=" +
                                  urlGlobal +
                                  "product/" +
                                  widget.product.slug;
                              _launchURL(url);
  ...
  Widget build(BuildContext context) {
    List<String> listBahanAktif = widget.product.bahan_aktif != null
        ? widget.product.bahan_aktif.split(',')
        : [];
                    ...
                    icon: new Stack(children: <Widget>[
                      Provider.of<AppModel>(context).loggedIn
                          ? new Container(
                              ...
                              child: Provider.of<WishModel>(context).loading
                                  ? LoadingRing(context)
                            ...
                            ? new Swiper(
                                itemBuilder: (BuildContext context, int index) {
                                  return new CachedNetworkImage(
                                    imageUrl: pictures[index] != null
                                        ? img_url + pictures[index]
                                        : "",
                                ...
                                children: <Widget>[
                                  if (widget.product.nomer_bpom != null)
                                    Container(
                                      ...
                                      child: Text(
                                        widget.product.nomer_bpom != null
                                            ? widget.product.nomer_bpom
                                            : "",
                                        style: TextStyle(
                                            fontSize: 12,
                                            fontFamily: 'Brandon'),
                          ...
                          children: <Widget>[
                            ...
                            Align(
                              ...
                              child: Text.rich(TextSpan(children: <InlineSpan>[
                                ...
                                TextSpan(
                                    text: '(' +
                                        widget.product.review_count.toString() +
                                        ')',
                                    style: TextStyle(
                                      fontSize: 12,
                                    ))
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    if (widget.product.is_flash_deal !=
                                        null) // tampilan diskon flash sale
                                      Padding(
                                        ...
                                        child: Text(
                                          varian != null
                                              ? NumberFormat.simpleCurrency(
                                                      ...
                                                      decimalDigits: 0)
                                                  .format(varian.price)
                                              : widget.product.is_flash_deal !=
                                                          null ||
                                                      widget.product.discount >
                                                          0
                                                  ? widget.product
                                                      .home_discounted_price
                                                  : widget.product.home_price,
                                          style: TextStyle(
                                            color: Color(0xffF48262),
                                            fontFamily: 'Brandon',
                                            fontSize: 18,
                                    ...
                                    if (widget.product.discount != null &&
                                        ...
                                        widget.product.is_flash_deal == null)
                                      Padding(
                                        padding: EdgeInsets.only(right: 10),
                                        child: Text(
                                          varian != null
                                    ...
                                    if (widget.product.is_flash_deal != null)
                                      Container(
                                        ...
                                        child: widget.product.is_flash_deal
                                                    .discount_type ==
                                                "percent"
                                            ? Text(
                                                '(' +
                                    ...
                                    if (widget.product.discount != null &&
                                      ...
                                      Container(
                                        padding:
                                            EdgeInsets.symmetric(horizontal: 7),
                                        child: widget.product.discount_type ==
                                                "percent"
                                            ? Text(
                                                '(' +
                                                    widget.product.discount
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        widget.product.penggunaan != null
                                            ? widget.product.penggunaan
                                            : "",
                                        style: TextStyle(
                                          fontFamily: 'Brandon',
                                          fontSize: 13,
                                ...
                                child: Consumer<ProductModel>(
                                  builder: (context, value, child) {
                                    if (value.loadingRekomendasi) {
                                      ...
                                      var dataRekomedasi = Lodash().chunk(
                                          array: value.Recomendasi, size: 3);
                                      return new Swiper(
                                        itemBuilder:
                                            (BuildContext context, int index) {
                                          if (dataRekomedasi[index].length ==
                                              3) {
                                            return Container(
                                                child: Row(children: [
                                              for (Product e
                                                  in dataRekomedasi[index])
                                                Expanded(
                                                  flex: 1,
                                                  child: Container(
                                                    padding:
                                                ...
                                                image: DecorationImage(
                                                    ...
                                                    image: NetworkImage(review
                                                        ...
                                                        : review.user.gender ==
                                                                "P"
                                                            ? img_url +
                                                                "frontend/images/avatar/avatar-female.png"
                                                            : img_url +
                                                                "frontend/images/avatar/avatar-male.png"))),
                                          ),
                                        )),
                                    Expanded(
                                      flex: 4,
                  ...
                  child: Row(
                    children: [
                      FlatButton(
                        ...
                        minWidth: 0,
                        child: Icon(
                          Provider.of<WishModel>(context).rawlist.firstWhere(
                                      (element) =>
                                          element.productId ==
                                          widget.product.id,
                                      orElse: () => null) !=
                                ...
                                ? Provider.of<WishModel>(context)
                                    .removeProductFromWish(
                                        ...
                                        Provider.of<AppModel>(context)
                                            .auth
                                            .access_token)
                                    .then((value) => UIBlock.unblock(context))
                                : Provider.of<WishModel>(context)
                                    .addProductToWish(
                                        widget.product,
                                        Provider.of<AppModel>(context)
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: FlatButton(
                            ...
                            child: Text(
                              (varian != null && varian.stock_quantity > 0) ||
                                      (widget.product.varian.isEmpty &&
                                          widget.product.currentStock > 0) ||
                                      (widget.product.varian.isNotEmpty &&
                                          varian == null)
                                  ? 'MASUKKAN KERANJANG'
                                  : "STOK KOSONG",
                              style: TextStyle(
                            ...
                            onPressed: () {
                              ...
                              if (widget.product.is_shown) {
                                if (!(widget.product.varian.isNotEmpty &&
                                  ...
                                  scaffoldKey.currentState
                                      .showSnackBar(snackBarNoVariant);
                                }
                              } else {
                                final snackBar = SnackBar(
